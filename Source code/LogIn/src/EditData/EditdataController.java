...
public class EditdataController implements Initializable {
    ...
    Image add_student_releassed = new Image ("/EditData/editstudent.jpg");
    Image add_student_hover = new Image ("/EditData/editstudenthover.jpg");
    Image add_teacher_releassed = new Image ("/EditData/editteacher.jpg");
    Image add_teacher_hover = new Image ("/EditData/editteacherhover.jpg");
    Image add_employee_releassed = new Image ("/EditData/editemployee.jpg");
    Image add_employee_hover = new Image ("/EditData/editemployeehover.jpg");
    ...
    {
        Parent root = FXMLLoader.load(getClass().getResource("/std_edit/editstudent.fxml"));
        Scene scene = new Scene(root);
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        stage.setTitle("EDIT STUDENT DATA");
        stage.setScene(scene);
        stage.show();
    }
    ...
    {
        Parent root = FXMLLoader.load(getClass().getResource("/teacheredit/teacheredit.fxml"));
        Scene scene = new Scene(root);
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        stage.setTitle("EDIT TEACHER DATA");
        stage.setScene(scene);
        stage.show();
    }
    ...
    {
        Parent root = FXMLLoader.load(getClass().getResource("/editemployee/editemployee.fxml"));
        Scene scene = new Scene(root);
        Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        stage.setTitle("EDIT EMPLOYEE DATA");
        stage.setScene(scene);
        stage.show();
    }
