 ...
 */
public class SearchclassController implements Initializable {
    ...
    private void search()
    {
		...
		final String sql3 = "Select * from students where Class='" + this.classfield.getText() + "'";
