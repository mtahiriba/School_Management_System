...
public class TeachereditController implements Initializable {
    ...
    private void submitStudent(ActionEvent event) 
    {
        ...
        if (this.RollNumber.getText().equals("") | this.StudentName.getText().equals("") | this.FatherName.getText().equals("") | this.Caste.getText().equals("") | this.Address.getText().equals("") | this.GuardianNumber.getText().equals("") | this.GCNIC.getText().equals("") | this.PlaceOfBirth.getText().equals("") | this.Nationality.getText().equals("") | this.LastInstitute.getText().equals("") | this.student_user.getText().equals("") | this.student_pass.getText().equals("") | this.Grade.getText().equals("") | this.key.getText().equals("")) {
		...
		final String sql3 = "update teacher set Name='" + this.StudentName.getText() + "', FatherName='" + this.FatherName.getText() + "', Caste='" + this.Caste.getText() + "', Religion='" + this.Religion.getText() + "', Salary='" + this.ClassName.getText() + "', Address='" + this.Address.getText() + "', phone='" + this.GuardianNumber.getText() + "', PCNIC='" + this.GCNIC.getText() + "', PlaceofBirth='" + this.PlaceOfBirth.getText() + "', Nationality='" + this.Nationality.getText() + "', Subject='" + this.LastInstitute.getText() + "', Username='" + this.student_user.getText() + "', Grade='" + this.Grade.getText() + "', SubjectKey='" + this.key.getText() + "', password='" + this.student_pass.getText() +"' where id='" + this.RollNumber.getText() + "'";
        ...
        else
        {
            ...
            try
            {
                ...
                if(con!=null)
                {
                    System.out.println("Connection Succesfully");
                    Statement st= con.createStatement();
                    final String sql3 = "Select * from teacher where id='" + this.searchfield.getText() + "'";
                    ResultSet rs= st.executeQuery(sql3);
                
                    if(rs.next()) 
                    {
                        this.RollNumber.setText(rs.getString(17));
