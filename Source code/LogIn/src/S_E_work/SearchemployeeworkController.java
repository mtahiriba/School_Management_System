 ...
 */
public class SearchemployeeworkController implements Initializable {
    ...
    private void search()
    {
		...
		final String sql3 = "Select * from employee where Work='" + this.workfield.getText() + "'";
